...
<div class="block">
  ...
  <jr-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></jr-cascader>
</div>
<div class="block">
...
```html
<jr-cascader :options="options"></jr-cascader>
...
:::demo
```html
<jr-cascader :options="options" clearable></jr-cascader>
...
```html
<jr-cascader :options="options" :show-all-levels="false"></jr-cascader>
...
```html
<jr-cascader :props="props"></jr-cascader>
...
```html
<jr-cascader-panel :options="options"></jr-cascader-panel>
